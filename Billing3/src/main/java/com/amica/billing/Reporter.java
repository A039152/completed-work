...
public class Reporter {
	...
	public static final String PROP_OUTPUT_FOLDER = "Reporter.outputFolder";
	public static final String PROP_AS_OF_DATE = "Reporter.asOfDate";
	...
	public Reporter(Configuration config) {
		String folderName = config.getString(PROP_OUTPUT_FOLDER);
		String dateString = config.getString(PROP_AS_OF_DATE);
		// dateString must be "2022-01-08" or something valid
		LocalDate parsedDate = LocalDate.parse(dateString);

		this.billing = new Billing(config);
		this.outputFolder = Paths.get(folderName);
		this.asOf = parsedDate;
	}
