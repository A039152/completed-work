...
public class TestProgram {
	...
	public static Node createFile(String name, int size, String lastModified) {
		Date modifiedDate = parseDate(lastModified);
		return new File(name, size, modifiedDate);
	}
	public static Node createHiddenFile(String name, int size, String lastModified) {
		Date modifiedDate = parseDate(lastModified);
		return new HiddenFile(name, size, modifiedDate);
	}
	// Utility method to parse a string into a Date object
	private static Date parseDate(String lastModified) {
